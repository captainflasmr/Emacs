...
;;
(dolist (pkg '(acp agent-shell async csv-mode dape doom-themes ef-themes emojify gruvbox-theme i3wm-config-mode modus-themes org-social ox-hugo package-lint ready-player selected-window-accent-mode simply-annotate timu-caribbean-theme timu-rouge-theme timu-spacegrey-theme use-package web-mode yaml-mode ztree))
