  ...
  '((dyerdwelling
     (org-bootstrap-publish-source-files
      . ("~/publish/hugo-unified/blog.org"
         ...
         "~/publish/hugo-unified/dad-dictionary.org"
         "~/publish/hugo-unified/README.org"))
     (org-bootstrap-publish-output-dir   . "~/publish/hugo-unified/public")
    ...
    (art
     (org-bootstrap-publish-source-files . ("~/publish/hugo-unified/art.org"))
     (org-bootstrap-publish-output-dir   . "~/publish/hugo-unified/public")
     ...
     (org-bootstrap-publish-menu-links
      . (("gallery" . "/tags/gallery/")
         ...
         ("2022"    . "/tags/2022/"))))
    (katieboo85
     (org-bootstrap-publish-source-files . ("~/publish/hugo-unified/kate.org"))
     (org-bootstrap-publish-output-dir   . "~/publish/hugo-unified/public")
     (org-bootstrap-publish-site-title   . "KatieBoo85")
     (org-bootstrap-publish-site-tagline . "Katherine's Recipe Collection")
    ...
    (emacs
     (org-bootstrap-publish-source-files . ("~/publish/hugo-unified/README.org"))
     ...
     (org-bootstrap-publish-author       . "James Dyer")
     (org-bootstrap-publish-static-dirs  . nil)
...
(defun my/obp-use-site (name)
  "Switch active org-bootstrap-publish site to NAME.
Resets every var in `my/obp-managed-vars' to its defcustom default
first, then applies the chosen profile.  Profiles can therefore
omit anything that matches the package default."
  (interactive
